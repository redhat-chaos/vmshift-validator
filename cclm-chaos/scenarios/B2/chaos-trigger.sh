...
#
# B2 — Packet loss via node-network-chaos, self-gated on VMIM Running
#
# Injects egress packet loss on source cluster worker nodes using the
...
echo "=============================================="
echo " B2 — Packet loss (${LOSS_PERCENT}%) on ${INTERFACE}"
...
echo "[$(ts)] B2 chaos-trigger complete."
